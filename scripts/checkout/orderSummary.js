...
export function renderOrderSummary() {
        ...
        <div class="cart-item-details-grid">
          ...
          <div class="cart-item-details">
            ...
            <div class="product-quantity">
              ...
              <span class="update-quantity-link link-primary js-update-item-quantity">
                Update
              </span>
  ...
  // FIXED: moved inside renderOrderSummary
  document.querySelector('.js-order-summary').innerHTML =
    cartSummaryHTML;

  // FIXED: selector name
  document.querySelectorAll('.js-update-item-quantity')
    .forEach((button) => {
